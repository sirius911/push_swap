...
int	get_hold_first(int *stack, int size)
{
	int	i;
	int j;
...
int	get_hold_second(int *stack, int size)
{
	int	i;
	int j;
...
void	algo_hundred(t_list **stack_a, t_list **stack_b, t_list **op)
{
	...
	while (*stack_a)
	{
		...
		//printf("size = %d\n", size);
		hold_first_row = get_hold_first(tab, size);
		hold_second_row = get_hold_second(tab, size);
...
// void algo_hundred3(t_list **stack_a, t_list **stack_b)
// {
// 	/*
